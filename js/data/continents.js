export const CONTINENTS = {
  ...
  'Comoros': 'Africa', 'Congo (DRC)': 'Africa', 'Congo (Republic)': 'Africa',
  'Costa Rica': 'North America', "Côte d'Ivoire": 'Africa', 'Croatia': 'Europe',
  ...
  'Ghana': 'Africa', 'Greece': 'Europe', 'Grenada': 'North America',
  ...
  'Kazakhstan': 'Asia', 'Kenya': 'Africa', 'Kiribati': 'Oceania',
  ...
  'Mexico': 'North America', 'Micronesia': 'Oceania', 'Moldova': 'Europe',
  ...
  'North Macedonia': 'Europe', 'Norway': 'Europe',
  'Oman': 'Asia',
  'Pakistan': 'Asia', 'Palau': 'Oceania', 'Palestine': 'Asia', 'Panama': 'North America',
  ...
  'San Marino': 'Europe', 'Sao Tome and Principe': 'Africa',
...
export function continentClass(continent) {
  return 'continent-' + continent.toLowerCase().replace(/\s+/g, '-');
}
